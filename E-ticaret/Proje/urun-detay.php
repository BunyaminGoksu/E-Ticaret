...
if ($say == 0) {
    header("Location:index.php?durum=şampiyoncimbom");
}
                ...
                <div id="myTabContent" class="tab-content shop-tab-ct">
                   ...
                   <?php } ?>" id="rev">
                        ...
                        ?>
                            ...
                            <p class="dash">
                                <span><?php echo $kullanicicek['kullanici_adsoyad'] ?></span> (<?php echo $yorumcek['yorum_zaman'] ?>)<br><br>
                        ...
                        <?php } else { ?>
                            ...
                            Yorum yazabilmek için <a style="color:red" href="register.php"> kayıt </a>olmalı yada giriş yapmalısınız..
                        ...
                        <div class="productwrap">
                            <div class="pr-img">
                                ...
                                <div class="pricetag on-sale">
                                    <div class="inner on-sale"><span class="onsale"><span class="oldprice"><?php echo $urunaltcek['urun_fiyat'] * 1.50 ?>TL</span><?php echo $urunaltcek['urun_fiyat'] ?>TL</span></div>
                                </div>
                            </div>
