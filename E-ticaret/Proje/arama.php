        ...
        <div class="col-md-9">
            ...
            <div class="title-bg">
                ...
                <div class="title-nav">
                    ...
                    <a href="avascript:void(0)"><i class="fa fa-bars"></i>List</a>
                </div>
            </div>
            <div class="row prdct">
                        ...
                        <div class="productwrap">
                            <div class="pr-img">
                                ...
                                <div class="pricetag on-sale">
                                    <div class="inner on-sale"><span class="onsale"><span class="oldprice"><?php echo $uruncek['urun_fiyat'] * 1.50 ?>TL</span><?php echo $uruncek['urun_fiyat'] ?>TL</span></div>
                                </div>
                            </div>
